defmodule NarouUpdateNotifyBot.Command.Novel.ReadLater.ChangeToUpdateNotify do
  use NarouUpdateNotifyBot.Command
  alias NarouUpdateNotifyBot.Repo.{Novels, UsersReadLaterNovels, UsersCheckNovels}
